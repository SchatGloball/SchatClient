...
class ChatsRpcClient extends $grpc.Client {
  ...
  static final _$updateApp = $grpc.ClientMethod<$0.UpdateAppReq, $0.UpdateAppRes>(
      '/ChatsRpc/UpdateApp',
      ($0.UpdateAppReq value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.UpdateAppRes.fromBuffer(value));
  static final _$notification = $grpc.ClientMethod<$0.RequestDto, $0.ResponseDto>(
      '/ChatsRpc/Notification',
      ($0.RequestDto value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.ResponseDto.fromBuffer(value));
  static final _$searchMessage = $grpc.ClientMethod<$0.SearchRequestDto, $0.ChatDto>(
      '/ChatsRpc/SearchMessage',
      ($0.SearchRequestDto value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.ChatDto.fromBuffer(value));
  static final _$forwardMessage = $grpc.ClientMethod<$0.ChatDto, $0.ResponseDto>(
      '/ChatsRpc/ForwardMessage',
      ($0.ChatDto value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.ResponseDto.fromBuffer(value));
  static final _$reactionMessage = $grpc.ClientMethod<$0.ReactionMessageDto, $0.ResponseDto>(
      '/ChatsRpc/ReactionMessage',
      ($0.ReactionMessageDto value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.ResponseDto.fromBuffer(value));
  static final _$deleteReactionMessage = $grpc.ClientMethod<$0.ReactionMessageDto, $0.ResponseDto>(
  ...
  $grpc.ResponseFuture<$0.ResponseDto> editGroupChat($0.ChatDto request, {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseStream<$0.UpdateDTO> listenEvent($0.RequestDto request, {$grpc.CallOptions? options}) {
    return $createStreamingCall(_$listenEvent, $async.Stream.fromIterable([request]), options: options);
  }

  $grpc.ResponseFuture<$0.UpdateAppRes> updateApp($0.UpdateAppReq request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updateApp, request, options: options);
  }

  $grpc.ResponseFuture<$0.ResponseDto> notification($0.RequestDto request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$notification, request, options: options);
  }

  $grpc.ResponseFuture<$0.ChatDto> searchMessage($0.SearchRequestDto request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$searchMessage, request, options: options);
  }

  $grpc.ResponseFuture<$0.ResponseDto> forwardMessage($0.ChatDto request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$forwardMessage, request, options: options);
  }

  $grpc.ResponseFuture<$0.ResponseDto> reactionMessage($0.ReactionMessageDto request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$reactionMessage, request, options: options);
  }

  $grpc.ResponseFuture<$0.ResponseDto> deleteReactionMessage($0.ReactionMessageDto request, {$grpc.CallOptions? options}) {
...
abstract class ChatsRpcServiceBase extends $grpc.Service {
  ...
  ChatsRpcServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.ReactionMessageDto, $0.ResponseDto>(
        ...
        false,
        false,
        ($core.List<$core.int> value) => $0.ReactionMessageDto.fromBuffer(value),
        ($0.ResponseDto value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.ReactionMessageDto, $0.ResponseDto>(
  ...
  $async.Future<$0.ResponseDto> editGroupChat_Pre($grpc.ServiceCall $call, $async.Future<$0.ChatDto> $request) async {
  ...
  $async.Stream<$0.UpdateDTO> listenEvent_Pre($grpc.ServiceCall $call, $async.Future<$0.RequestDto> $request) async* {
    yield* listenEvent($call, await $request);
  }

  $async.Future<$0.UpdateAppRes> updateApp_Pre($grpc.ServiceCall $call, $async.Future<$0.UpdateAppReq> $request) async {
    return updateApp($call, await $request);
  }

  $async.Future<$0.ResponseDto> notification_Pre($grpc.ServiceCall $call, $async.Future<$0.RequestDto> $request) async {
    return notification($call, await $request);
  }

  $async.Future<$0.ChatDto> searchMessage_Pre($grpc.ServiceCall $call, $async.Future<$0.SearchRequestDto> $request) async {
    return searchMessage($call, await $request);
  }

  $async.Future<$0.ResponseDto> forwardMessage_Pre($grpc.ServiceCall $call, $async.Future<$0.ChatDto> $request) async {
    return forwardMessage($call, await $request);
  }

  $async.Future<$0.ResponseDto> reactionMessage_Pre($grpc.ServiceCall $call, $async.Future<$0.ReactionMessageDto> $request) async {
    return reactionMessage($call, await $request);
  }

  $async.Future<$0.ResponseDto> deleteReactionMessage_Pre($grpc.ServiceCall $call, $async.Future<$0.ReactionMessageDto> $request) async {
  ...
  $async.Future<$0.ResponseDto> editGroupChat($grpc.ServiceCall call, $0.ChatDto request);
  ...
  $async.Stream<$0.UpdateDTO> listenEvent($grpc.ServiceCall call, $0.RequestDto request);
  $async.Future<$0.UpdateAppRes> updateApp($grpc.ServiceCall call, $0.UpdateAppReq request);
  $async.Future<$0.ResponseDto> notification($grpc.ServiceCall call, $0.RequestDto request);
  $async.Future<$0.ChatDto> searchMessage($grpc.ServiceCall call, $0.SearchRequestDto request);
  $async.Future<$0.ResponseDto> forwardMessage($grpc.ServiceCall call, $0.ChatDto request);
  $async.Future<$0.ResponseDto> reactionMessage($grpc.ServiceCall call, $0.ReactionMessageDto request);
  $async.Future<$0.ResponseDto> deleteReactionMessage($grpc.ServiceCall call, $0.ReactionMessageDto request);
}
